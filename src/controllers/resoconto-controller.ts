...
export const ultimoResoconto = async (req: CustomRequest, res: Response) => {
    if (req.userId) {
        try {
...
export const inserimentoResoconto = async (req: CustomRequest, res: Response) => {
...
export const getResocontiUtente = async (req: CustomRequest, res: Response) => {
